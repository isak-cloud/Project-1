...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">IsakMohammed is qualified cloud engineer.leaving in uk,and has world class quality of education and wide range of certificates. Isak Mohammed is dedicated, highly motivated and help customers to get the job done in qucik and professional way with less efforts.
	    </p>
	    <p><strong>Address:</strong>  Flat no: 656, 2nd Floor, Buckingham Palace, Central London, United Kingdom</p> 
	    <p><strong>Ph No: </strong>  +44-2085678912,208245689</p>
		<p><strong>E-Mail ID :</strong>  isak.mohammed@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> isakmohammed.com</a></p>
</footer>
